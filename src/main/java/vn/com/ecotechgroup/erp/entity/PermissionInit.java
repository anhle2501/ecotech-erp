...
public class PermissionInit {
	...
	private void createPermission(String prefix) {
		List<Permission> permissions = this.permissionRep
				.findPermissionByNameStartingWith(prefix);
		if (permissions.isEmpty()) {
			permissions.add(new Permission(prefix + ":read", "Chức năng đọc"));
			permissions.add(
					new Permission(prefix + ":create", "Chức năng tạo mới"));
			permissions.add(
					new Permission(prefix + ":update", "Chức năng cập nhật"));
			permissions
					.add(new Permission(prefix + ":delete", "Chức năng xóa"));
			permissions.add(
					new Permission(prefix + ":upload", "Chức năng tải lên"));
			permissions.add(new Permission(prefix + ":download",
					"Chức năng tải xuống"));
			permissions.add(
					new Permission(prefix + ":report", "Chức năng báo cáo"));
			try {
